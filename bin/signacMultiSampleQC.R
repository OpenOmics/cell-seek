...
option_list <- list(
  ...
  make_option(
    ...
    action = "store",
    default = NA,
    help = "Comma-delimited list of paths to 10X output filtered peak directories"
  ),
  make_option(
    c("-s", "--samples"),
    type = "character",
    action = "store",
    default = "sample",
    help = "Comma-delimited list of sample names (must match order of datapaths)"
  ),
  make_option(
    c("-p", "--project"),
    type = "character",
...
datapaths <- strsplit(opt$datapaths, ",")[[1]] %>% trimws()
samples <- strsplit(opt$samples, ",")[[1]] %>% trimws()

if (length(datapaths) != length(samples)) {
  stop("Number of datapaths must match number of samples")
}
...
annotations <- import(opt$reference)
...
for (i in 1:length(samples)) {
  ...
  counts <- Read10X_h5(file.path(datapaths[i], "filtered_peak_bc_matrix.h5"))
  cellranger_metrics <- read.csv(
    file = file.path(datapaths[i], "singlecell.csv"),
    header = TRUE,
    row.names = 1
  )
  ...
  chrom_assay <- CreateChromatinAssay(
    ...
    fragments = file.path(datapaths[i], "fragments.tsv.gz"),
    min.cells = 1,
    min.features = 1
  )
...
for (i in 1:length(samples)) {
  ...
  # Get fragment path
  fragment_path <- file.path(datapaths[i], "fragments.tsv.gz")
...
for (sample in samples) {
  ...
  png(
    paste0("PreFilter_Feature_Plot_", sample, ".png"),
    height = 5,
    width = 15,
    units = "in",
    res = 300
...
write.csv(thresh_df, "cell_filter_info.csv", row.names = FALSE)
...
for (sample in samples) {
  ...
  png(
    paste0("PreFilter_VlnPlot_ATAC_", sample, ".png"),
    height = 7,
    width = 10,
    units = "in",
    res = 300
  ...
  png(
    paste0("PreFilter_VlnPlot_QC_", sample, ".png"),
    height = 7,
    width = 5,
    units = "in",
    res = 300
...
for (sample in samples) {
  ...
  png(
    paste0("PreFilter_TSS_Enrichment_Plot_", sample, ".png"),
    height = 7,
    width = 10,
    units = "in",
    res = 300
  ...
  png(
    paste0("PreFilter_Fragment_Length_Plot_", sample, ".png"),
    height = 7,
    width = 10,
    units = "in",
    res = 300
  )
  print(FragmentHistogram(object = seur_subset, group.by = "Sample"))
  dev.off()
}
...
png("PreFilter_UMAP_ATAC.png", width = 1800, height = 1600, res = 300)
DimPlot(seur, reduction = "umap", label = TRUE, group.by = "Sample") +
  ggtitle("Pre-Filter UMAP") +
  theme(plot.title = element_text(hjust = 0.5))
dev.off()

png("PreFilter_UMAP_ATAC_Clusters.png", width = 1800, height = 1600, res = 300)
...
for (sample in samples) {
  ...
  png(
    paste0("PreFilter_UMAP_ATAC_Filter_", sample, ".png"),
    width = 1800,
    height = 1600,
    res = 300
  )
...
for (sample in samples) {
  ...
  png(
    paste0("PreFilter_FeaturePlot_Counts_", sample, ".png"),
    width = 1800,
    height = 1600,
    res = 300
  )
  ...
  png(
    paste0("PreFilter_FeaturePlot_QC_", sample, ".png"),
    width = 1800,
    height = 1600,
    res = 300
  )
...
for (sample in samples) {
  ...
  png(
    paste0("PostFilter_Feature_Plot_", sample, ".png"),
    height = 5,
    width = 15,
    units = "in",
    res = 300
...
for (sample in samples) {
  ...
  png(
    paste0("PostFilter_VlnPlot_ATAC_", sample, ".png"),
    height = 7,
    width = 10,
    units = "in",
    res = 300
  ...
  png(
    paste0("PostFilter_VlnPlot_QC_", sample, ".png"),
    height = 7,
    width = 5,
    units = "in",
    res = 300
...
for (sample in samples) {
  ...
  png(
    paste0("PostFilter_TSS_Enrichment_Plot_", sample, ".png"),
    height = 7,
    width = 10,
    units = "in",
    res = 300
  ...
  png(
    paste0("PostFilter_Fragment_Length_Plot_", sample, ".png"),
    height = 7,
    width = 10,
    units = "in",
    res = 300
...
for (sample in samples) {
  ...
  png(
    paste0("PostFilter_FeaturePlot_Counts_", sample, ".png"),
    width = 1800,
    height = 1600,
    res = 300
  )
  ...
  png(
    paste0("PostFilter_FeaturePlot_QC_", sample, ".png"),
    width = 1800,
    height = 1600,
    res = 300
  )
...
png("ElbowPlot_LSI.png", height = 7, width = 7, units = "in", res = 300)
...
png("UMAP_by_Sample.png", width = 1800, height = 1600, res = 300)
